...
<?php echo app('toastr')->render(); ?>
  ...
  $('.selectmultiple2').select2({
   ...
   $('.selectmultiple3').select2({
    ...
    <?php echo $__env->make("include.theme-control", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profglobal/public_html/demoafficity/resources/views/include/script.blade.php ENDPATH**/ ?>