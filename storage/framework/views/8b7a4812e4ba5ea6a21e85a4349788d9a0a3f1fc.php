                                ...
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                             <a href="<?php echo e(url('technican/lists')); ?>" class="btn btn-danger reset-btn">Cancel</a>
                                        </div>
                                        <label class="col-sm-3 col-form-label"></label>
                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\demoafficity\resources\views/admin/technican/list/edit.blade.php ENDPATH**/ ?>