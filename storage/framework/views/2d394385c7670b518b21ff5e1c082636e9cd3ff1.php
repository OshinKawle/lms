...
<?php $__env->startSection('title', 'Admin City'); ?>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-lg-flex align-items-center mb-4 gap-3">
              <div class=""><a href="<?php echo e(url('master/city/create')); ?>" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Create New City</a></div>
            </div>
            <?php endif; ?>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <input type="text" name="search_name" id="search_by_name-btn" class="form-control" placeholder="Search by City Name " value="<?php echo e(Request::get('search_name')); ?>">
                      </div>
                    </div>
                ...
                <thead class="table-light">
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>
                         <a href="<?php echo e(url('/master/city/changestatus/'.$list->id)); ?>" class="badge rounded-pill p-2 px-3 btn-<?php echo e(($list->status == 'Active') ? 'success' : 'danger'); ?> button_flow"  data-toggle="tooltip" data-placement="top" title=""  onclick="return confirm('Do you Really want to <?php echo e(($list->status == 'Active') ? 'Inactive' : 'Active'); ?> this City ?')"> <i class="fa <?php echo e(($list->status == 'Active') ? 'fa-toggle-on' : 'fa-toggle-off'); ?> fa-xl"></i></a>
                       </td>
                       <td>
                        <div class="d-flex order-actions">
                          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city-edit')): ?>
                        <a href="<?php echo e(url('master/city/'.$list->id.'/edit')); ?>" class=""><i class='bx bxs-edit'></i></a>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city-delete')): ?>
                        <a href="<?php echo e(url('/master/city/delete/'.$list->id)); ?>" class="ms-3" onclick="return confirm('Do you really Want to Delete the  City ?')"><i class='bx bxs-trash'></i></a>
                        <?php endif; ?>
                      </div>
                    </td>
                     </tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profglobal/public_html/demoafficity/resources/views/admin/master/city/index.blade.php ENDPATH**/ ?>