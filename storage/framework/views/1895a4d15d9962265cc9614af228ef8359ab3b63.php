                ...
                <div class="boxset1">
                    <div class="d-flex">
                        <div class="bgfafa1">
                            ...
                            <img class="fafabox1" src="<?php echo e(asset('admin/assets/images/student.png')); ?>">
                        </div>
                ...
                <div class="boxset2">
                    <div class="d-flex">
                        <div class="bgfafa2">
                            ...
                            <img class="fafabox1" src="<?php echo e(asset('admin/assets/images/badge.png')); ?>">
                        </div>
            ...
            <div class="col-md-2">
                <div class="boxset3">
                    <div class="d-flex">
                        <div class="bgfafa3">
                            <!-- <i class="fa fa-user fafabox1" aria-hidden="true"></i> -->
                            <img class="fafabox1" src="<?php echo e(asset('admin/assets/images/subject.png')); ?>">
                        </div>
                ...
                <div class="boxset4">
                    <div class="d-flex">
                        <div class="bgfafa4">
                            ...
                            <img class="fafabox1" src="<?php echo e(asset('admin/assets/images/e-learning.png')); ?>">
                        </div>
                ...
                <div class="boxset5">
                    <div class="d-flex">
                        <div class="bgfafa5">
                            ...
                            <img class="fafabox1" src="<?php echo e(asset('admin/assets/images/test.png')); ?>">
                        </div>
                ...
                <div class="boxset6">
                    <div class="d-flex">
                        <div class="bgfafa6">
                            ...
                            <img class="fafabox1" src="<?php echo e(asset('admin/assets/images/rupee.png')); ?>">
                        </div>
    ...
    <div class="container-fluid contwidth">
        <div class="row">
            ...
            <div class="col-md-3 ">
                <div class="dpubg">
                    <div>
                        <img class="dpulogo" src="<?php echo e(asset('admin/assets/images/dpu_logo.png')); ?>">
                    </div>
...
<?php echo $__env->make("layouts.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\oshin\xampp\htdocs\lms\resources\views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>