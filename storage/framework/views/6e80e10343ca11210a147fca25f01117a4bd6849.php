...
<?php $__env->startSection("wrapper"); ?>
 <div class="container-fluid popup">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-sm-6 col-12">
                        <div class="service-content-right">
                            ...
                            <br />
                            <ul>
                                <input type="hidden" name="userlat" value="" id="userlat">
                                <input type="hidden" name="userlong" value="" id="userlong">
                                <input type="hidden" name="postal" value="" id="postal">
                                 <input type="hidden" name="name_address" value="" id="name_address">
                                <input type="hidden" name="house_address" value="" id="house_address">
                                <input type="hidden" name="apart_address" value="" id="apart_address">
                                <input type="hidden" name="direction_address" value="" id="direction_address">
                                <li>
    ...
    <?php echo $__env->make('frontend.booking.datetime_popup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection("script"); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\demoafficity\resources\views/frontend/booking/index.blade.php ENDPATH**/ ?>