  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="BookingClosed()">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="BookingClosed()">Close</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="PaymentClosed()">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
                     ...
                     <div class="row">
                      <input type="hidden" name="booking_id" value="" id="booking_p_id">
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12">
                            <div class="form-group">
                                <label for="form1">Comment</label>
                                <span class="star label-mandatory">*</span>
                                <input type="text" name="comment"  class="form-control input-mandatory ">
                            </div>
                        </div> 
                    </div>
                    <div class="row" style="margin-top:1%!important">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="PaymentClosed()">Close</button>
        <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
      </div>
    </div>
  </div>
...
<?php /**PATH D:\xampp\htdocs\demoafficity\resources\views/admin/booking/list/js.blade.php ENDPATH**/ ?>