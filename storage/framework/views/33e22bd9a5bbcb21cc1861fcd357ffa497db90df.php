              ...
              <table class="table mb-0">
                <thead class="table-light">
                    <tr>
                     ...
                     <th>Technican Wallet Amount</th>
                     <th>Wallet Add Amount</th>
                     <th>Wallet Debit Amount</th>
                    </tr>
                   <?php 
                      $page=1;
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>
                      ₹ <?php echo e(isset($list->wallet) ? $list->wallet->amount : 0); ?>

                       </td>
                        <td>
                          <div class="">
                           
                        <a href="<?php echo e(url('technican/wallet/'.$list->id.'/edit')); ?>" class="">Add Amount</a>
                      </div>
                       </td>
                       <td>
                        <div class="d-flex ">
                          
                        <a href="<?php echo e(url('technican/wallet/debit/'.$list->id)); ?>" class="">Debit Amount</a>
                      </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profglobal/public_html/demoafficity/resources/views/admin/technican/wallet/index.blade.php ENDPATH**/ ?>