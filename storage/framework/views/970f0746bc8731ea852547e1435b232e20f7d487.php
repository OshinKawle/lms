            ...
            <div class="col-md-10">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-uni" role="tabpanel"
                        ...
                        <div class="formbd">
                            <form action="<?php echo e(url('master/university')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div>
...
<?php echo $__env->make("layouts.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\oshin\xampp\htdocs\lms\resources\views/admin/master/university/create.blade.php ENDPATH**/ ?>