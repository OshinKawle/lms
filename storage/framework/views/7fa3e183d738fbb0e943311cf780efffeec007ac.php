              ...
              <table class="table mb-0">
                <thead class="table-light">
                    <tr>
                     ...
                     <th>Booking Status Date</th>
                     <th>Booking Status Time</th>
                     <th>Comment</th>
                   ...
                   <tbody>
                     <tr>
                       ...
                       <button type="button" class="btn <?php echo e(($list->booking_status_id == 3 ? 'btn-danger' : ($list->booking->booking_status_id == 5 ? 'btn-success' : 'btn-info'))); ?>" > <?php echo e(isset($list->bookingStatus) ? $list->bookingStatus->name : ''); ?> </button>
                       <?php else: ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\demoafficity\resources\views/admin/booking/list/bookinghistory.blade.php ENDPATH**/ ?>