 <nav class="navbar navbar-expand-lg bg-light navbarset sticky-top">
        <div class="container-fluid">
            <img class="logoset" src="<?php echo e(asset('admin/assets/images/Profcyma.png')); ?>" alt="">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0  menualign">
                    <li class="nav-item menuitemspace">
                        <a class="nav-link active menuset activemenu" aria-current="page" href="<?php echo e(url('home')); ?>">Overall
                            Stats</a>
                    </li>
                    ...
                    <li class="nav-item menuitemspace">
                        <a class="nav-link menuset" href="<?php echo e(url('master/university')); ?>">Master</a>
                    </li>
    ...
    </nav><?php /**PATH D:\oshin\xampp\htdocs\lms\resources\views/layouts/header.blade.php ENDPATH**/ ?>