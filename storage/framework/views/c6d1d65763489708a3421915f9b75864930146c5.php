            ...
            <div class="modal-content" style="border-color: black;">
                ...
                <form class="form-signin" style="max-width: 900px;">
                    ...
                    <button class="btn btn-lg btn-primary btn-block" type="button" onclick="ConfirmLocation();"
                        style="border-radius:5rem; margin-top: 15px;">CONFIRM</button>
                </form>
            </div>
        </div>
    </div>
    <!--Map Popup End--><?php /**PATH /home/profglobal/public_html/demoafficity/resources/views/frontend/booking/map_popup.blade.php ENDPATH**/ ?>