          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Join Us Enquiry</li>
              </ol>
            </nav>
          </div>
        </div>
            ...
            <form role="form" method="get" action="">
                <div class="box-body">
                  <div class="row">
                   ...
                   <div class="col-md-1">
                     <a href="<?php echo e(url('customer/joinUsEnquiry')); ?>" class="btn btn-danger reset-btn">Reset</a>
                   </div>
                 </div>
               </div>
             </form>
                ...
                <thead class="table-light">
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td><?php echo e($list->appliedFor->name); ?></td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profglobal/public_html/demoafficity/resources/views/admin/customer/joinUsEnquiry/index.blade.php ENDPATH**/ ?>