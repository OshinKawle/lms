 <!-- partial:index.partial.html -->
    <div id="datetime_popup" class="modal app-container" ng-app="dateTimeApp" ng-controller="dateTimeCtrl as ctrl"
        ng-cloak>
        ...
        <div date-picker datepicker-title="Select Date" picktime="true" pickdate="true" pickpast="false"
            ...
            <div class="datepicker" style="border: solid 2px #0DAD83;" ng-class="{
                                        'am': timeframe == 'am',
                                        'pm': timeframe == 'pm',
                                        'compact': compact
                                    }">
                ...
                <div class="datepicker-calendar">
                    <div class="calendar-header">
                        ...
                        <div class="current-month-container"></div>
                    ...
                    <div class="calendar-day-header">
                        <span ng-repeat="day in days" class="day-label"></span>
                    </div>
                ...
                <div class="buttons-container">
                    <div id="datetime_close" class="cancel-button" onclick="GoBackToIndex();">CANCEL</div>
                    <button id="btnContinueDate" class="save-button" type="button" onclick="ContinueAfterDate();"
                        style="border-radius:5rem;">CONTINUE</button>
                </div>

            </div>
        </div>
    </div>
    <!-- partial --><?php /**PATH F:\xampp\htdocs\affixcity\resources\views/frontend/booking/datetime_popup.blade.php ENDPATH**/ ?>