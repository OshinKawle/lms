<div class="container-fluid" id="contactus">
                                ...
                                <form>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <input id="ContactName" placeholder="Full Name" class="form-control"
                                                type="text">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="email" class="form-control" id="ContactEmail"
                                                placeholder="Email" pattern=".+@globex\.com" />
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <input id="ContactMobile" placeholder="Mobile No." class="form-control"
                                    ...
                                    <div class="form-row">
                                        <button type="button" class="btn btn-primary" onclick="ValidateContactForm();"
        ...
        </div><?php /**PATH F:\xampp\htdocs\affixcity\resources\views/frontend/home/contact.blade.php ENDPATH**/ ?>