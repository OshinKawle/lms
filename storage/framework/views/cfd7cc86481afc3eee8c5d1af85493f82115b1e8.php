                        ...
                        <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-info">New Serive</h5>
                                    </div>
                                    <hr/>
                                    <form method="post" action="<?php echo e(url('service/lists')); ?>"  onsubmit="return validateForm('addsstatus')" class="addsstatus" autocomplete="off" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                     <div class="row mb-3">
                                        <label for="Name" class="col-sm-3 col-form-label">Service Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control input-mandatory" id="banner" name="name" value="<?php echo e(old('name')); ?>" placeholder="Service Name">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="file" class="form-control input-mandatory" value="" id="image" name="image"> 
                                        </div>
                                          <div class="col-sm-6">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/profglobal/public_html/demoafficity/resources/views/admin/service/list/create.blade.php ENDPATH**/ ?>