            ...
            <div class="col-md-10">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-uni" role="tabpanel"
                        ...
                        <div class="formbd">
                           <form method="post" action="{{ url('master/university/'.$detail->id) }}"  onsubmit="return validateForm('addsstatus')" class="addsstatus" autocomplete="off" enctype="multipart/form-data">
                                    @csrf
                                     {{ method_field('PATCH') }}
                                <div class="row">
                                    <div class="col-md-3">
                                        <div>
                                            ...
                                            <input class="form-control" type="text" name="name"
                                                placeholder="Enter University" value="{{$detail->name}}">
                                        </div>
                                    </div>
                                </div>
                                <br>
